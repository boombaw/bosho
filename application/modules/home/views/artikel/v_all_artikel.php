		...
		<div class="col-md-12 col-sm-12 col-xs-12">
			...
			<?php foreach($artikels as $row){?>
				<div class="single-blog-img">
					<a href="<?php echo base_url(); ?>home/artikel/detail">
				...
				<div class="blog-text">
					<h4>
						<a href="<?php echo base_url(); ?>home/artikel/detail"><?php echo $row->judul?></a>
					</h4>
					<p>
				...
				<span>
					<a href="<?php echo base_url(); ?>home/artikel/detail" class="ready-btn">Read more</a>
				</span>
				<hr>
			<?php }?>
			</div>

                ...
                <div class="login-wrap">
                    <div class="login-content">
                        <div class="login-logo">
                            <a href="#">
                                <img src="<?php echo base_url();?>unggah/logo/bkkbn.jpg" alt="Si Pasutri">
                            </a>
                        </div>
						<hr>
                        <div class="login-form">
							...
							<div style="color:red;"><?php echo $this->session->flashdata('error');?></div>
                                ...
                                <button class="au-btn au-btn--block au-btn--blue m-b-20" type="submit" data-toggle="tooltip" title="Masuk">Masuk</button>
